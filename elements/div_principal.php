...
<div id="principal">
    ...
    <div id="post">
        <form method="post" name="formulaire" enctype="multipart/form-data">
            <div id="img_text_post">
                ...
                <textarea name="texte_post" id="texte_post" cols="65" rows="3" placeholder="Raconte ta vie ici <?php echo $_SESSION['prenom']?>."></textarea>
            </div>
            <div id="insert_image">
    ...
    <div id="dernier_post">
        <?php
            ...
            $post_par_pages = 15;
            $nbr_post = $bdd->query('SELECT id FROM post');
            ...
            $recup_post = $bdd->query('SELECT id, id_utilisateur, contenu, num_image, nbr_like, DATE_FORMAT(date_creation, \'%d/%m/%Y\') AS date_creation_fr FROM post ORDER BY id DESC LIMIT '. $page_de_depart .','. $post_par_pages .'');
            ...
            while ($donnees = $recup_post->fetch()) {
                ...
                <div id="post_amis">
                    ...
                    ?>
                    <div id="like_comment">
                        <a href="elements/nbr_like.php?id_post=<?php echo $donnees['id']?>&page_actuelle=<?php echo $page_courrante?>" id="like_btn"><?php echo $donnees['nbr_like'] ?> J'aime</a>
                        ...
                        <a href="commentaires.php?id_post=<?php echo $donnees['id']?>&page_actuelle=<?php echo $page_courrante?>&retour=mur&utilisateur=<?php echo $_SESSION['id'] ?>" id="commentaire"><?php echo $nbre_commentaire['nbr_commentaire'] ?> Commentaires</a>
                    </div>
                    <?php
                ...
                <div id="conteur_page">
                    ...
                    for ($i = 1; $i <= $nbr_page_totale; $i ++) {
                        if ($i == $page_courrante) {
                            ...
                            echo '<a href="mur.php?page='. $i .'">'. $i .'</a>';
                        }
                    }
                    ?>
                </div>
